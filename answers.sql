...
SELECT models.name, brands.name, brands.headquarters FROM models JOIN brands USING (brand_id) WHERE models.name='Mustang';
...
SELECT brand_id, name, founded, headquarters, discontinued FROM brands ORDER BY founded LIMIT 3;
...
SELECT model_id, year, brand_id, name FROM models ORDER BY name OFFSET 15 LIMIT 10;
...
SELECT models.year, models.name, models.model_id, awards.name FROM models FULL OUTER JOIN awards ON models.model_id=awards.winner_id WHERE models.year>=1964;
...
SELECT b.name, m.name, m.year, b.discontinued, b.discontinued-m.year FROM models AS m
...
SELECT brands.name, brands.founded FROM brands LEFT JOIN models ON brands.brand_id=models.brand_id
